...
var validate = function (validations) {
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _i, validations_1, validation, result, err;
...
exports.loginvalidator = [
    ...
    (0, express_validator_1.body)("password").trim().isLength({ min: 6 }).notEmpty().withMessage("password is required")
];
exports.signupvalidator = __spreadArray([
    (0, express_validator_1.body)("name").notEmpty().withMessage("Name is required")
], exports.loginvalidator, true);
